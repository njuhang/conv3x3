#ifndef _CONV3X3_SKEL_H
#define _CONV3X3_SKEL_H
/// @file conv3x3.idl
///
//qidl copyright
//qidl nested=false
#include "conv3x3.h"
__attribute__ ((visibility("default"))) uint32_t conv3x3_skel_handle_invoke_qaic_version = 10041;
...
extern "C" {
#endif
static __inline int _skel_method(int (*_pfn)(remote_handle64, const uint8*, int, uint8*, int, const uint8*, int, uint32), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   char* _rout1[1];
   ...
   _TRY(_nErr, _pfn(_h, (const uint8*)*_in0, (int)*_in0Len, (uint8*)*_rout1, (int)*_rout1Len, (const uint8*)*_in2, (int)*_in2Len, (uint32)*_in3));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_1(int (*_pfn)(remote_handle64, const uint8*, int, uint8*, int, const uint8*, int, int32, uint32), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   char* _rout1[1];
   ...
   _TRY(_nErr, _pfn(_h, (const uint8*)*_in0, (int)*_in0Len, (uint8*)*_rout1, (int)*_rout1Len, (const uint8*)*_in2, (int)*_in2Len, (int32)*_in3, (uint32)*_in4));
   _CATCH(_nErr) {}
   return _nErr;
}
static __inline int _skel_method_2(int (*_pfn)(remote_handle64, const uint8*, int, uint8*, int, const uint8*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   remote_arg* _praEnd;
   char* _in0[1];
   uint32_t _in0Len[1];
   char* _rout1[1];
   ...
   _ASSERT(_nErr, ((_praIn[1].buf.nLen / 1)) >= (size_t)(_in2Len[0]));
   _in2[0] = _praIn[1].buf.pv;
   _TRY(_nErr, _pfn(_h, (const uint8*)*_in0, (int)*_in0Len, (uint8*)*_rout1, (int)*_rout1Len, (const uint8*)*_in2, (int)*_in2Len));
   _CATCH(_nErr) {}
   return _nErr;
}
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(conv3x3_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc))
   {
      case 0:
      return _skel_method_4(__QAIC_IMPL(conv3x3_open), _sc, _pra);
      case 1:
      return _skel_method_3(__QAIC_IMPL(conv3x3_close), _sc, _pra);
      case 2:
      return _skel_method_2(__QAIC_IMPL(conv3x3_sum), _h, _sc, _pra);
      case 3:
      return _skel_method_1(__QAIC_IMPL(conv3x3_intrinsicimp), _h, _sc, _pra);
      case 4:
      return _skel_method(__QAIC_IMPL(conv3x3_halideimp), _h, _sc, _pra);
   }
